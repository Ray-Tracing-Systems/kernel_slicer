...
vk_utils::VulkanDeviceFeatures TestVecDataAccessFromMember_Generated_ListRequiredDeviceFeatures();
...
int main(int argc, const char** argv)
{
  ...
  if(onGPU)
  {
    ...
    auto features = TestVecDataAccessFromMember_Generated_ListRequiredDeviceFeatures();
