...
{
  if(!Inside(to_float3(pos), to_float3(SCENE_BOX_MIN), to_float3(SCENE_BOX_MAX)))
    return 0.0f;

  float3 vox = Normalize(to_float3(pos), to_float3(SCENE_BOX_MIN), to_float3(SCENE_BOX_MAX));
