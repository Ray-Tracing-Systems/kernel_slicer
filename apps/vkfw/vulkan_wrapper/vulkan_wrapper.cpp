...
void* libVulkan;
int32_t vk_android::screenDensity;
...
namespace vk_android
{
  ...
  void getDeviceConfig(android_app* androidAppCtx)
  {
    // Screen density
    AConfiguration* config = AConfiguration_new();
    AConfiguration_fromAssetManager(config, androidAppCtx->activity->assetManager);
...
//  {
//    JNIEnv* jni;
//    androidAppCtx->activity->vm->AttachCurrentThread(&jni, NULL);
//
//    jstring jmessage = jni->NewStringUTF(message);
//
//    jclass clazz = jni->GetObjectClass(androidAppCtx->activity->clazz);
...
//    jni->CallVoidMethod(androidAppCtx->activity->clazz, methodID, jmessage);
