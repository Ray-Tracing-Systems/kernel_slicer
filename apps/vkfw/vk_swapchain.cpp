...
VkQueue VulkanSwapChain::CreateSwapChain(const VkPhysicalDevice &physicalDevice, const VkDevice &logicalDevice, VkSurfaceKHR &surface,
                                         uint32_t &width, uint32_t &height, bool vsync, VkSurfaceTransformFlagsKHR& a_preTransform)
{
  ...
  InitSurface(surface);
  Create(width, height, vsync, a_preTransform);
...
*/
void VulkanSwapChain::Create(uint32_t &width, uint32_t &height, bool vsync, VkSurfaceTransformFlagsKHR& a_preTransform)
{
