...
\chapter{Измеряем время выполнения и копирования}

В предыдущей главе мы опустили некоторые детали, в частности Вы могли заметить что в тестовом классе присутствуют функции CommitDeviceData и GetExecutionTime, которые никак не использовались. 

\section{Запуск второго примера}
